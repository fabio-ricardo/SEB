...
descBandas[1][5] = 1957 #Irradiância Espectral no Topo da Atmosfera
descBandas[1][6] = (descBandas[1][4] - descBandas[1][3]) / 255 # (b[i] - a[i]) / 255
...
descBandas[2][5] = 1826 #Irradiância Espectral no Topo da Atmosfera
descBandas[2][6] = (descBandas[2][4] - descBandas[2][3]) / 255 # (b[i] - a[i]) / 255
...
descBandas[3][5] = 1554 #Irradiância Espectral no Topo da Atmosfera
...
descBandas[4][5] = 1036 #Irradiância Espectral no Topo da Atmosfera
descBandas[4][6] = (descBandas[4][4] - descBandas[4][3]) / 255 # (b[i] - a[i]) / 255
...
descBandas[5][6] = (descBandas[5][4] - descBandas[5][3]) / 255 # (b[i] - a[i]) / 255
...
descBandas[6][6] = (descBandas[6][4] - descBandas[6][3]) / 255 # (b[i] - a[i]) / 255
...
descBandas[7][6] = (descBandas[7][4] - descBandas[7][3]) / 255 # (b[i] - a[i]) / 255
#----------
